...
public class ListViewAdapter extends BaseAdapter {
    ...
    RadiusImageView lv;
    private ArrayList<ListViewItem> feederList = new ArrayList<ListViewItem>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RadiusImageView lv = (RadiusImageView) convertView.findViewById(R.id.musical_image);
        ...
        ListViewItem listViewItem = feederList.get(position);

        // 아이템 내 각 위젯에 데이터 반영

        lv.setImageDrawable(listViewItem.getImage());
